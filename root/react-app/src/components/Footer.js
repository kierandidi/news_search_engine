        ...
        <div className='row'>
          <div className='shadow-lg col-lg-12 text-center py-3 mt-4 bg-light text-dark rounded-bottom rounded-5'>
            <p className='col-lg-12'>
              This is a web development project as part of the 2022{' '}
              <a
                href='https://techlabs.org/de/location/duesseldorf/'
                target='_blank'
                rel='noreferrer'
              >
                Düsseldorf Techlabs
            ...
            <p className='col-lg-12'>
              Please find our project code repo here:{' '}
              <a
                href='https://github.com/kierandidi/news_search_engine'
                target='_blank'
                rel='noreferrer'
              >
                <img
